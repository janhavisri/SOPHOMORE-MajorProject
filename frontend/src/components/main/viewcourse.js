...
const ViewCourse = () => {
  return (
    <div class="row">
      <div class="col-sm-6">
        <div class="">
          <div class="container-flui bg-danger text-light p-5 text-center ">
            <h1>Courses Details</h1>
          </div>
          <div class="p-5">
            <div>
              <img
                src="https://softwarelozi.com/wp-content/uploads/2021/01/What-are-Web-development-services.jpg"
                class="img-fluid"
                alt="img"
              />
            </div>
        ...
        <div>
          <div class="p-5">
            ...
            <h4 class="text-center">
              Every Developer a basic understanding of HTML, CSS and JAVASCRIPT
            </h4>
            <h4 class="text-center">
      ...
      >
        <Paper elevation={16}>
          <div className="row-left">
            ...
            ></img>
            <p class="pl">Responsive web design</p>
            <img
              class="imgaa"
              src="https://cdn-icons-png.flaticon.com/128/3938/3938598.png"
            ></img>
            <p class="p">Animation Effect</p>
            <img
              class="imgag"
              src="https://cdn-icons.flaticon.com/png/128/1084/premium/1084269.png?token=exp=1648223966~hmac=ccff754d758206134865e6006b407667"
            ></img>
            <p class="pa">Multimedia Website</p>
            <img
              class="imgage"
              src="https://cdn-icons-png.flaticon.com/128/1322/1322104.png"
            ></img>
            ...
            <img
              class="imgagess"
              src="https://cdn-icons.flaticon.com/png/128/3494/premium/3494099.png?token=exp=1648224700~hmac=c661473c443fe13a0a3c969f6688baaf"
            ></img>
